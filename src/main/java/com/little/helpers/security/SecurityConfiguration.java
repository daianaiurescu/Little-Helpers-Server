...
//                .antMatchers("/Authenticate","User").permitAll();
        ...
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers("/Authenticate","/Organisations", "/Users", "/Home", "/Save", "/SaveVolunteer", "/GetVolunteers","/GetVolunteer","/User/{id}","/user/token","/user/logout", "/Products", "/SaveProduct").permitAll()
